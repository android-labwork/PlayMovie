...
public class SearchTVShowActivity extends AppCompatActivity {
    ...
    private SearchTVShowViewModel movieViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieViewModel = ViewModelProviders.of(this).get(SearchTVShowViewModel.class);
        ...
        public void onChanged(final ArrayList<Item> items) {
            movieAdapter.setItems(items, new MovieAdapter.MovieHandler() {
                ...
                public void onItemClick(int position) {
                    Intent intent = new Intent(SearchTVShowActivity.this, DetailMovieActivity.class);
            ...
            if (items.size() == 0) Toast.makeText(SearchTVShowActivity.this, R.string.msg_not_found, Toast.LENGTH_LONG).show();
