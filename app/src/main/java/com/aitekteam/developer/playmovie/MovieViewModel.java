...
public class MovieViewModel extends ViewModel implements Callback<Movies>,
    ...
    public MutableLiveData<ArrayList<Item>> getItems(Context context, Activity activity, int argument, String API, String language, int page) {
        ...
        if (items == null) {
            ...
            if (argument == 0) {
                ...
                Call<Movies> call = api.getMovies(API, language, page);

                call.enqueue(this);
            }
            else activity.getLoaderManager().initLoader(0, null, this);
        }
        return items;
    }
    ...
    public void onFailure(Call<Movies> call, Throwable t) {
        Log.d("MovieFragment", "Request Failed");
    }
